...
const plans = [
  ...
  { name: "VPS Stratos", tagline: "Built to scale.", ram: "16 GB DDR4", cpu: "6 vCPU (Intel Xeon)", storage: "90 GB NVMe", bandwidth: "3 TB", price: "₹999", popular: true, image: vpsNetwork },
  { name: "VPS Dominus", tagline: "Pure muscle.", ram: "32 GB DDR4", cpu: "12 vCPU (Intel Xeon)", storage: "150 GB NVMe", bandwidth: "5 TB", price: "₹1,980", image: vpsNetwork },
...
const VPSHosting = () => (
  <Layout>
    <PageHeroBanner
      image={vpsBanner}
      title="VPS Hosting"
      subtitle="Intel Xeon Power · NVMe Speed · Always Protected"
    />
    ...
    <section className="max-w-7xl mx-auto px-6 pb-16">
      ...
      <div className="mt-12 text-center glass-panel p-8 max-w-2xl mx-auto">
        <h3 className="font-display font-bold text-foreground text-xl mb-2">Custom Plan Also Available!!</h3>
        <p className="text-muted-foreground text-sm mb-4">Need different specs? We can build a plan tailored to your needs.</p>
        <a
      ...
      <div className="mt-16 max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-6">
          {["Enterprise Security", "Blazing Performance", "Powered by EB Nodes"].map((item) => (
