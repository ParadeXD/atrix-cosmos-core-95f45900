        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <a href="https://believe.ebnodes.in" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5">
